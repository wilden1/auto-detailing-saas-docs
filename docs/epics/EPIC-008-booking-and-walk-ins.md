...
created: 2026-09-19
updated: 2026-09-19
related: [PG-001, MOD-007]
---

# EPIC-008 — Booking & Walk-ins
...
Schedule future appointments and handle customers who arrive without one, through to check-in.
...
| ID | Question |
| --- | --- |
| [`OQ-010`](../product/open-questions.md) | Can customers self-book online? |
| [`OQ-020`](../product/open-questions.md) | Is scheduling capacity-aware — bays, technicians, job duration? |
| [`OQ-022`](../product/open-questions.md) | Is a walk-in a booking created on arrival, or a separate concept? |
...
OQ-020 is the difference between a calendar and a capacity-planning system. It should be answered before this epic is refined.
