...
created: 2026-09-19
updated: 2026-09-19
related: [PG-001, MOD-014]
---

# EPIC-015 — Dashboard & Reporting
...
Show owners, branch managers and staff what is happening in the business, and report on it across branches where authorized.
...
| ID | Question |
| --- | --- |
| [`OQ-005`](../product/open-questions.md) | What measurable outcomes define success? Without these, we do not know what to report. |
| [`OQ-015`](../product/open-questions.md) | What may one branch see of another's data — which constrains every cross-branch report? |
...
Reporting appears in the product direction twice: as area 1 (Dashboard) and inside area 14 (Staff, Roles & Reporting). The boundary between this epic and EPIC-003 needs settling during refinement.
