...
| --- | --- | --- |
| [vision.md](vision.md) | `UNDER DISCUSSION` | Why the product exists, product goals `PG-001`–`PG-006` |
| [scope.md](scope.md) | `PROPOSED` | Product areas under consideration, and the boundaries not yet decided |
...
| [open-questions.md](open-questions.md) | `CONFIRMED` (process) | `OQ-001`–`OQ-040` — everything not yet decided |
